...
- Sin fotos de stock. Imágenes: proyectos reales o ilustraciones SVG propias.
...
- Performance: nada de vídeos autoplay pesados; imágenes optimizadas y `loading="lazy"`.
